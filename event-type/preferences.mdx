---
title: "Preferences"
description: Customize your event type preferences including calendar display names, colors, visibility settings, and confirmation redirects.
"og:title": "Event Type Preferences - Novacal Help Center"
"og:description": "Customize your event type preferences including calendar display names, colors, visibility settings, and confirmation redirects."
"twitter:title": "Event Type Preferences - Novacal Help Center"
"twitter:description": "Customize your event type preferences including calendar display names, colors, visibility settings, and confirmation redirects."
---
...
You can also redirect attendees to a custom page after they finish booking.

### Redirect to Custom URL After Booking

Enable the redirect option in the **Preferences** tab if you want attendees to land somewhere other than the default Novacal confirmation screen.

This is useful for:

- **Thank-you pages** - Send attendees to a branded confirmation page on your website
- **Onboarding flows** - Guide new leads to the next step right after booking
- **Instructions pages** - Share prep materials, forms, or post-booking details

### Redirect URL

Enter the full URL you want attendees to visit after booking, for example:

`https://your-website.com/thank-you`

If redirect is enabled, make sure the URL is valid and publicly accessible.
