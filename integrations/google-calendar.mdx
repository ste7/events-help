...
"og:title": "Google Calendar Integration - Novacal Help Center"
"og:description": "Integrate your Google Calendars with Novacal to automatically add events, sync existing events, and prevent double bookings."
"twitter:title": "Google Calendar Integration - Novacal Help Center"
"twitter:description": "Integrate your Google Calendars with Novacal to automatically add events, sync existing events, and prevent double bookings."
---

## How to connect your Google Calendar account

1. Navigate to the [Apps & Integrations](https://app.novacal.io/integrations) page and go to [Google Calendar](https://app.novacal.io/integrations/google-calendar)
